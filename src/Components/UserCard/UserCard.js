...
export default function UserCard({ profile, name, city, intrests }) {
  ...
  return (
    <div className="flex flex-row flex-wrap content-center gap-4 bg-[#FBFCFF] w-full md:min-h-[150px]  lg:w-[32.33%] lg:min-h-[220px] rounded-2xl p-6 hover:border hover:border-[#BFC8E5] hover:shadow-xl">
      ...
      <div className="flex flex-col w-3/5 min-h-[100px] md:h-full md:mt-12">
        <h1 className="font-merri text-base md:text-lg font-black text-mirage">{name}</h1>
        <h2 className="font-poppins text-xs md:text-sm font-medium text-mirage">{city}</h2>
